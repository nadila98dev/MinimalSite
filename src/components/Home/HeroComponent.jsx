  ...
  return (
    <div className='h-full w-full grid md:grid-cols-2 m-auto items-center'>
        ...
        <span> overall wellness</span>
            ...
            <p>A high concentration vitamin C serum formulated
                for all skin types it boosts skin's glow and makes it 
                look healthy overall
            </p>
                <div className='flex justify-start'>            
                <button type='button' className='mt-10 bg-black hover:bg-gray-800 text-white font-bold py-4 px-5'>EXPLORE PRODUCTS</button>
                </div>
        </div>
