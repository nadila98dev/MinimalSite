...
const Membership = () => {
  return (
    ...
    <div className='m-5 md:m-20'>
      <div className='grid grid-cols-1 md:grid-cols-2 text-left space-x-10'>
        <div className='md:order-1'>
          ...
          <section className='mt-5 space-y-5'>
            ...
            <button className='bg-black text-white hover:bg-gray-800 font-bold h-auto w-[190px] px-2 py-2'>Get Membership</button>
          </section>
        </div>
